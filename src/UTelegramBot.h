...
private:
    char* send(const char* method, const char* chatId = nullptr, const char* text = nullptr, const char* replyMarkup = nullptr);
...
private:
    ...
    static void handleUpdatesTask(void *pvParameters);
    void internalHandleUpdates();
